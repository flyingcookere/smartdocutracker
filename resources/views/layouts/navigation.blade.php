<nav x-data="{ open: false }" class="dark:bg-gray-800/60 dark:border-gray-700/50 bg-white/90 backdrop-blur-sm border-gray-100/50 border-b">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('images/bulsuLogo.png') }}" alt="" width="50px" height="50px">
            ...
            <div class="sm:flex sm:items-center sm:ms-6 hidden">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="text-crimson dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none inline-flex items-center px-3 py-2 text-sm font-medium leading-4 transition duration-150 ease-in-out bg-transparent border border-transparent rounded-md">
